                         ...
                         <div class="alert alert-success"><i class="icon-info-sign"></i> Please Fill in required details</div>		
							...
							<form class="form-horizontal" method="post">			
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_serialnm" id="inputPassword" placeholder="Device Serial Number" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_serial" id="inputPassword" placeholder="Inventory Code" required>
											</div>
										</div>
