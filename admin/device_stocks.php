...
<?php
		...
		<td><?php
			...
			<td><?php echo $row['tgl_garansi']; ?></td>
			...
			<td class="empty" width="80"><a rel="tooltip"  title="Edit Device" id="e<?php echo $id; ?>" href="device_detail.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"> Details</i></a></td>
		</tr>
