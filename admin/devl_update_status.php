        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('device_location_slidebar.php'); ?>
                    ...
                    <div class="control-group">
                     <label class="control-label" for="inputPassword">Device Status</label>
                     <div class="controls">
                       <select id="qtype" name="dev_status" readonly="readonly" required>

                         <option value="<?php echo $row['status']; ?>" ><?php echo $row['status']; ?></option>
                         <?php
                         $device_query = mysql_query("select * from dev_status")or die(mysql_error());
                         while($query_device_row = mysql_fetch_array($device_query)){
                         $dev_name = $row['status'];
                         ?>
                         <option value="<?php echo $query_device_row['status']; ?>"><?php echo $query_device_row['status'];  ?></option>
                         <?php } ?>
										...
										mysql_query("insert into activity_log (date,username,dev_id,action) values(NOW(),'$admin_username','$get_id','Update Status $dev_name to $dev_status ')")or die(mysql_error());
										?>
										<script>
