									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Move TO</label>
				                            ...
				                            <option></option>
				                             ...
				                             <option value="<?php echo $row['stdev_id']; ?>_<?php echo $row['stdev_location_name']; ?>"><?php echo $row['stdev_location_name']; ?></option>
				                             <?php } ?>
				                           </select>
		                                </div>
	                                   </div>
										...
										mysql_query("update location_details set
													...
													stdev_id = '$stdev_id'													
													where id = '$get_id' ")or die(mysql_error());
										mysql_query("insert into activity_log (date,username,dev_id,action) values(NOW(),'$admin_username','$get_id','Transfer to $stdev_id')")or die(mysql_error());			
										?>
										<script>
